 ...
 * Player.java
 *
 * <p>An abstract player that all other players will implement from
 *
 * @author Chris Wolf
...
public abstract class Player {
   ...
   * @param representation the character that will represent the player on the board (X/O)
   */
  ...
  public boolean equals(Object other) {
    ...
    return representation == player.representation && name.equals(player.name);
  }
