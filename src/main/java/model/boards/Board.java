 ...
 * Board.java
 *
 * <p>A generic board that all other boards can inherit from
 *
 * @author Chris Wolf
...
public abstract class Board {
  ...
  public boolean hasPlayerWon(Player player) {
    return this.hasPlayerWonByRows(player)
        || this.hasPlayerWonByCols(player)
  ...
  /**
   * Determines whether or not the player has won by three in the top-left to bottom-right diagonal
   *
   * @param player the player we are checking
   * @return true if the player has won by three in the top-left to bottom-right diagonal, false
   *     otherwise
   */
  ...
  /**
   * Determines whether or not the player has won by three in the top-right to bottom-left diagonal
   *
   * @param player the player we are checking
   * @return true if the player has won by three in the top-right to bottom-left diagonal, false
   *     otherwise
   */
